    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 21, 17, 38, 5, 320, DateTimeKind.Local).AddTicks(6618), "Gala", "Fruits", "Fresh and juicy", "images\\galaapplejuiced.jpg", "Apple", 1.99m },
                    { 2, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7316), "Chiquita", "Fruits", "Ripe and sweet", "images\\Chiquitabanana.jpg", "Banana", 0.99m },
                    { 3, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7334), "Alpro", "Dairy", "Whole milk", "images\\alpromilk.jpg", "Milk", 2.49m },
                    { 4, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7338), "Jacquet", "Bakery", "Whole wheat bread", "images\\jacquetbread.jpg", "Bread", 2.29m },
                    { 5, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7339), "Maïski", "Meat", "Boneless skinless chicken breast", "images\\maiskichicken.jpg", "Chicken", 4.99m },
                    { 6, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7345), "Iglo", "Vegetables", "Fresh organic spinach", "images\\iglospinach.jpg", "Spinach", 1.49m },
                    { 7, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7347), "Alpro", "Dairy", "Low-fat yogurt", "images\\alproyogourt.jpg", "Yogurt", 1.79m },
                    { 8, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7349), "Columbus", "Other", "Large brown eggs", "images\\columbuseggs.jpg", "Eggs", 2.99m },
                    { 9, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7351), "Tropicana", "Beverages", "100% pure orange juice", "images\\tropicanaorangejuice.jpg", "Orange Juice", 3.49m },
                    { 10, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7389), "Galak", "SweetFood", "Milk chocolate bar", "images\\chocolatgalak.jpg", "Chocolate", 1.29m },
                    { 11, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7392), "Waitrose ", "Cerials", "Oat, wheat and barley flakes with mixed dried fruits, nuts and seeds", "images\\essentialfoodandnut.jpg", "Essential Fruit & Nut Muesli", 3m },
                    { 12, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7399), "Waitrose ", "Cerials", "Cereal (34 %) and Raisin (9.5 %) Bar Half Covered with Milk Chocolate (19 %).", "images\\LN_002834_BP_11.jpg", "Cadbury Brunch Bar Raisin", 1.55m },
                    { 13, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7401), "Waitrose ", "SweetFood", "Lemon flavoured soft bakes.", "images\\LN_895684_BP_11.jpg", "Lu Le Petit Citron Lemon Soft Bakes", 1.55m },
                    { 14, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7403), "Flash", "CleaningProduct", "Kitchen degreaser. Removes up to 100% of grease. With plant-based ingredient (12% of total surfactant, which are subject to processing).", "images\\LN_002490_BP_11.jpg", "Flash Task Kitchen Spray Fresh Citrus800ml", 2.5m },
                    { 15, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7406), "Nivea", "PersonalCare", "Instantly protects from 5 signs of skin irritation: burning, redness, dryness, tightness & micro cuts.", "images\\LN_060554_BP_11.jpg", "Nivea For Men Sensitive Gel200ml", 4.25m },
                    { 16, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7409), "Waitrose", "FrozenFoods", "Lovely frozen cod wihich is absolutely delicious.", "images\\LN_847760_BP_11.jpg", "Waitrose Frozen Cod Fillets MSC475g", 8.50m },
                    { 17, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7411), "Iglo", "FrozenFoods", "Basa fillets dusted in a flour breadcrumb coating, with sea salt and cracked black pepper", "images\\LN_821034_BP_11.jpg", "Young's Gastro Salt & Pepper Dusted Basa Fillets 2s310g", 4.50m },
                    { 18, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7414), "Tesco", "CannedGoods", "Chopped tomatoes in tomato juice.", "images\\grownhastesttomato.jpg", "Grower's Harvest Chopped Tomatoes 400G", 0.50m },
                    { 19, new DateTime(2024, 2, 21, 17, 38, 5, 321, DateTimeKind.Local).AddTicks(7415), "Apojo", "Beverages", "PROSECCO DENOMINAZIONE D'ORIGINE CONTROLLATA BRUT PRODUCE OF ITALY", "images\\processo.jpg", "Finest Prosecco Doc 75Cl", 8.50m }
                });
